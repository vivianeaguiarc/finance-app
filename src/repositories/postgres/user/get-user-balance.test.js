...
describe('PostgresGetUserBalanceRepository', () => {
    ...
    it('should get user balance on db including percentages', async () => {
        let createdUserId
        ...
        // Total = 10.000 + 2.000 + 3.000 = 15.000
        const total = 15000

        // Porcentagens esperadas
        expect(result.earningsPercent).toBeCloseTo((10000 / total) * 100)
        expect(result.expensesPercent).toBeCloseTo((2000 / total) * 100)
        expect(result.investmentsPercent).toBeCloseTo((3000 / total) * 100)
    })
    ...
    it('should return percentage = 0 for all categories if totals are zero', async () => {
        const sut = new PostgresGetUserBalanceRepository()
        ...
        expect(result.expensesPercent).toBe(0)
        expect(result.investmentsPercent).toBe(0)
    })
})
